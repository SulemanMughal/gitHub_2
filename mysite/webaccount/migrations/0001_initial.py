# Generated by Django 2.2 on 2020-04-05 07:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Number_of_subaccounts', models.IntegerField(verbose_name='Number of Sub-Accounts')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('contactNumber', models.CharField(default='', max_length=10, verbose_name='Contact Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Approved', 'Approved'), ('Rejected', 'Rejected')], default='Approved', max_length=10, verbose_name='Status')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webaccount.relationManager', verbose_name='RM'),
        ),
        migrations.AddField(
            model_name='client_personal_info',
            name='sector',
